...
void EmuController::run_sm() {
    switch (this->negotiantion_state) {
        default:
        case NEG_INIT:
            this->negotiantion_state=NEG_WAIT_FOR_PD_TRANS;
            break;
        ...
        case NEG_WAIT_FOR_PD_TRANS:
            ...
            this->negotiantion_state=NEG_WAIT_FOR_PD;
            break;

        case NEG_WAIT_FOR_PD:
            if (pd.is_PPS_ready())
                this->negotiantion_state = NEG_GOT_PPS_TRANS;
            else if (pd.is_power_ready())
                this->negotiantion_state = NEG_GOT_20V_TRANS;
            break;
        ...
        case NEG_GOT_20V_TRANS:
            ...
            set_power(true);
            this->negotiantion_state = NEG_GOT_20V;
            break;
        case NEG_GOT_20V: if (!pd.is_power_ready()) this->negotiantion_state=NEG_WAIT_FOR_PD_TRANS;
        ...
        case NEG_GOT_PPS_TRANS:
            ...
            this->emulator->enable();
            set_power(true);
            this->negotiantion_state = NEG_GOT_PPS;
            break;
        case NEG_GOT_PPS: if (!pd.is_PPS_ready()) this->negotiantion_state=NEG_WAIT_FOR_PD_TRANS;
    }
}
